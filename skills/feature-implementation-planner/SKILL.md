...
description: Build a safe implementation plan from an existing PRD, research findings, and a user solution sketch. Use when `./features/{feature-name}/PRD.md` and `RESEARCH.md` already exist and the user needs a `PLAN.md` with architecture, phased execution, requirement coverage, tests, and clarification of hidden breaking-change risks.
---
